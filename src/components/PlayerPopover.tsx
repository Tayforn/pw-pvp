...
import {
  ARMOR_REFINE_LABELS, ARMOR_SET_LABELS, CLASS_LABELS, GEMS_LABELS, GENIE_LABELS, SPECIAL_SET_LABELS, SPECIAL_SET_ORDER,
  TRACT_LABELS, WEAPON_GRADE_LABELS, WEAPON_REFINE_LABELS, rulesFor,
} from '../data/gearRules';
